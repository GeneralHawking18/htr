        ...
        self.aug = iaa.Sequential(
            iaa.SomeOf(
                ...
                [
                    sometimes(
                        iaa.OneOf(
                            [iaa.GaussianBlur(sigma=(0, 1.0)), iaa.MotionBlur(k=3)]
                        )
                    ),
                    sometimes(
                        iaa.SigmoidContrast(
                    ...
                    sometimes(
                        iaa.OneOf(
                            [
                                iaa.Dropout(p=(0, 0.1)),
                                iaa.CoarseDropout(
                                    p=(0, 0.1), size_percent=(0.02, 0.25)
                                ),
                            ]
                        )
                    ),
